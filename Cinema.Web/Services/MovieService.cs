    ...
    public class MovieService
    {
        ...
        public bool PayForTickets(int cartId)
        {
            ...
            try
            {
                ...
                mail.To.Add(emailTo);
                mail.From = new MailAddress("andrej.skenderski@gmail.com");
                mail.Subject = "Confirmation for your order on Cinema Lorem Ipsum";
                string Body = "You have successfully payed for the order of your tickets!";
                mail.Body = Body;
                ...
                smtp.Credentials = new System.Net.NetworkCredential("andrej.skenderski@gmail.com", "kirz1421.");
                smtp.EnableSsl = true;
                smtp.Send(mail);
